package kr.kro.sosohanbox.gumiinformationschool.school_lunch;

import android.content.Context;
import android.os.AsyncTask;
import android.util.Log;

import kr.kro.sosohanbox.gumiinformationschool.school_lunch.MealLibrary;
...
public abstract class ProcessTask extends AsyncTask<Integer, Integer, Long> {
    ...
    final String schulCode = "R100000758"; // 학교 고유 코드
    final String schulCrseScCode = "04"; // 학교 종류 코드 1
    final String schulKndScCode = "2"; // 학교 종류 코드 2
